...
int main()
{
	...
	Anillo_M = Model();
	Anillo_M.LoadModel("Models/Anillo.obj");
	...
	/*//LUZ HELICÓPTERO
	spotLights[3] = SpotLight(1.0f, 0.96f, 0.176f, //Color
	...
	while (!mainWindow.getShouldClose())
	{
		...
		shaderList[0].SetPointLights(pointLightstemp,m);
		shaderList[0].SetSpotLights(spotLightstemp, n);
