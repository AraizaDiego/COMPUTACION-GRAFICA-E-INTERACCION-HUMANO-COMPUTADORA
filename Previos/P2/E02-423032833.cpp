...
int main()
{
	...
	//ARBOL IZQUIERDO
		//Triangulo verde
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(-0.69f, -0.443f, -4.0f));
		model = glm::scale(model, glm::vec3(0.2f, 0.323f, 1.0f));
		...
		model = glm::scale(model, glm::vec3(0.19f, 0.23f, 1.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
	...
	//CASA
		...
		model = glm::scale(model, glm::vec3(0.53f, 0.365f, 1.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
